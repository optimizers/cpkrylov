...
cpk4 = @cpminres;
cpk_string4 = 'CPMINRES';
cpk5 = @cpsymmlq;
cpk_string5 = 'CPSYMMLQ';
cpk6 = @cpsymmlq_v0;
cpk_string6 = 'CPSYMMLQ-V0';
...
semilogy([0: size(cpk1stats.residHistory,1)-1],   cpk1stats.residHistory,   'b--+', ...
         ...
         [0: size(cpk4stats.residHistory,1)-1],   cpk4stats.residHistory,   'g-.s', ...
         [0: size(cpk5stats.cgresidHistory,1)-1], cpk5stats.cgresidHistory, 'k:d', ...
         [0: size(cpk5stats.qrresidHistory,1)-1], cpk5stats.qrresidHistory, 'r:x', ...
         [0: size(cpk5stats.lqresidHistory,1)-1], cpk5stats.lqresidHistory, 'b-<', ...
         [0: size(cpk6stats.cgresidHistory,1)-1], cpk6stats.cgresidHistory, 'c:+', ...
         [0: size(cpk6stats.lqresidHistory,1)-1], cpk6stats.lqresidHistory, 'm:o', ...
         'LineWidth', 2);
